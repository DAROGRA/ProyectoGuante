int valoresMin[5] = {100, 200, 300, 400, 500}; // Valores mínimos para cada entrada analógica
int valoresMax[5] = {500, 600, 700, 800, 900}; // Valores máximos para cada entrada analógica
